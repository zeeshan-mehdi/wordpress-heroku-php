...
if ( ! class_exists('Be_Page_Widget_Helper' ) ) {
	...
	* @since 1.0.0
	*/
	class Be_Page_Widget_Helper extends WP_Widget {
				...
				case 'url':
					...
					<p>
						...
						<?php if ( isset( $field['description'] ) && ! empty( $field['description'] ) ) : ?>
							<span class="widget-field-description"><em><?php echo $field['description']; ?></em></span>
						<?php endif; ?>
					</p>
