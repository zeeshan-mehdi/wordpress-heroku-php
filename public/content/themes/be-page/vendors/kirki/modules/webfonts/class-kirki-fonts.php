...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'be-page' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'be-page' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'be-page' ),
			'200'       => esc_attr__( 'Light 200', 'be-page' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'be-page' ),
			'300'       => esc_attr__( 'Book 300', 'be-page' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'be-page' ),
			'400'       => esc_attr__( 'Normal 400', 'be-page' ),
			'regular'   => esc_attr__( 'Normal 400', 'be-page' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'be-page' ),
			'500'       => esc_attr__( 'Medium 500', 'be-page' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'be-page' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'be-page' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'be-page' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'be-page' ),
			'700'       => esc_attr__( 'Bold 700', 'be-page' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'be-page' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'be-page' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'be-page' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'be-page' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'be-page' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'be-page' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'be-page' ),
		);
	}
