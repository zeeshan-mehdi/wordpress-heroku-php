...
class Kirki_Control_Image extends Kirki_Control_Base {
	...
	protected function content_template() {
		...
		data.choices.labels = _.defaults( data.choices.labels, {
			select: '<?php esc_attr_e( 'Select image', 'be-page' ); ?>',
			change: '<?php esc_attr_e( 'Change image', 'be-page' ); ?>',
			'default': '<?php esc_attr_e( 'Default', 'be-page' ); ?>',
			remove: '<?php esc_attr_e( 'Remove', 'be-page' ); ?>',
			placeholder: '<?php esc_attr_e( 'No image selected', 'be-page' ); ?>',
			frame_title: '<?php esc_attr_e( 'Select image', 'be-page' ); ?>',
			frame_button: '<?php esc_attr_e( 'Choose image', 'be-page' ); ?>',
		} );
		#>
		<label>
