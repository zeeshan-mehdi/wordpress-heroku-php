...
class Kirki_Control_Base extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'kirkiL10n',
			array(
				'noFileSelected'   => esc_attr__( 'No File Selected', 'be-page' ),
				'remove'           => esc_attr__( 'Remove', 'be-page' ),
				'default'          => esc_attr__( 'Default', 'be-page' ),
				'selectFile'       => esc_attr__( 'Select File', 'be-page' ),
				'standardFonts'    => esc_attr__( 'Standard Fonts', 'be-page' ),
				'googleFonts'      => esc_attr__( 'Google Fonts', 'be-page' ),
				'defaultCSSValues' => esc_attr__( 'Default CSS Values', 'be-page' ),
			)
		);
