...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args( $this->button_labels,
			array(
				'select'       => esc_attr__( 'Select image', 'be-page' ),
				'change'       => esc_attr__( 'Change image', 'be-page' ),
				'default'      => esc_attr__( 'Default', 'be-page' ),
				'remove'       => esc_attr__( 'Remove', 'be-page' ),
				'placeholder'  => esc_attr__( 'No image selected', 'be-page' ),
				'frame_title'  => esc_attr__( 'Select image', 'be-page' ),
				'frame_button' => esc_attr__( 'Choose image', 'be-page' ),
			)
		);
	}
