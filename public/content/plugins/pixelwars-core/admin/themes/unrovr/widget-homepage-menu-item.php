<?php
	...
	class pixelwars_core_Widget__Homepage_Menu_Item extends WP_Widget
	{
		public function __construct()
		{
			parent::__construct(
				...
				esc_html__('(Pixelwars Core) Homepage Menu Item', 'pixelwars-core'),
				array(
	...
	add_action('widgets_init', create_function('', 'register_widget("pixelwars_core_widget__homepage_menu_item");'));
