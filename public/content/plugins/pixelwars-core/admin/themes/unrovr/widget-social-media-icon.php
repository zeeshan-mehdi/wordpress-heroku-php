<?php
	...
	class pixelwars_core_Widget__Social_Media_Icon extends WP_Widget
	{
		public function __construct()
		{
			parent::__construct(
				...
				esc_html__('(Pixelwars Core) Social Media Icon', 'pixelwars-core'),
				array(
	...
	add_action('widgets_init', create_function('', 'register_widget("pixelwars_core_widget__social_media_icon");'));
